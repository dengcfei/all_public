...
def parse_args() -> tuple[str, list[str]]:
    parser = argparse.ArgumentParser(
        description="Unified monitor for HKEX and CNINFO listed-company financial reports"
    )
    parser.add_argument("provider", choices=["hkex", "cninfo"], help="Data source provider")
